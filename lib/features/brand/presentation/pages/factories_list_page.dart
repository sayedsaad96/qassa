                ...
                builder: (context, state) {
                  ...
                  if (state is FactoriesLoaded) {
                    ...
                    return RefreshIndicator(
                      onRefresh: () async => sl<FactoriesCubit>().loadFactories(),
      ...
      child: Column(
        ...
        children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(' · ${factory.reviewCount} تقييم', style: AppTextStyles.caption),
                      ],
                    ),
                  ],
                ),
          ...
          Wrap(
            ...
            runSpacing: 4,
            children: [
              ...factory.specialties.map((s) => AppChip(label: s, selected: true)),
              AppChip(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<FactoriesCubit, FactoriesState>(
          builder: (context, state) {
            ...
            if (state is FactoriesError) {
              return Scaffold(
                ...
                body: NetworkErrorWithIllustration(
                  onRetry: () => sl<FactoriesCubit>().loadFactoryById(widget.factoryId),
                ),
              );
            }
            ...
            if (state is FactoriesLoaded) {
              final f = state.factories.where((f) => f.id == widget.factoryId).firstOrNull;
            ...
            delegate: SliverChildListDelegate([
              ...
              Row(
                children: [
                  ...
                  Text(' · ${factory.reviewCount} تقييم', style: AppTextStyles.body.copyWith(color: AppColors.textSecondary)),
                ],
              ),
              const SizedBox(height: 10),
              Wrap(
              ...
              GridView.count(
                ...
                children: [
                  ...
                  _InfoTile(icon: '📦', label: 'الحد الأدنى', value: '${factory.minQuantity} قطعة'),
                  _InfoTile(icon: '⏱️', label: 'مدة التسليم', value: '${factory.leadTimeDays} يوم'),
                  _InfoTile(
                    icon: '⚡',
                    label: 'سرعة الرد',
                    value: factory.isFastResponder ? 'سريع < ساعتين' : 'عادي',
                    valueColor: factory.isFastResponder ? AppColors.success : null,
                  ),
                ],
              ),
              const SizedBox(height: 16),
              ...
              if (factory.portfolioImages.isEmpty)
                Container(
                  ...
                  child: const Center(child: Text('📷 لا توجد صور بعد', style: TextStyle(color: AppColors.textSecondary))),
                )
              else
                GridView.builder(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (_, i) => ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: factory.portfolioImages[i],
                      fit: BoxFit.cover,
